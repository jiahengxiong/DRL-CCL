    ...
    for buffer_index, value in route_table.items():
        ...
        while len(target_list) > 0:
            ...
            for target_node in target_list:
                path = nx.dijkstra_path(NVD2_topology, source=current_node, target=target_node, weight='weight')
                cost = nx.dijkstra_path_length(NVD2_topology, source=current_node, target=target_node,
                                               weight='weight')
